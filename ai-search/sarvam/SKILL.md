...
The `requests>=2.20.0` requirement addresses **PYSEC-2018-28**, a vulnerability where older versions of requests did not properly check SSL certificates. Version 2.20.0+ includes the fix for this security issue.
